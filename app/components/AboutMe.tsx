      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-white/80 text-center">
            ...
            <p className="text-lg">
              My journey began with Shopify theme development, which evolved into creating custom applications and integrations. I've worked with leading agencies to deliver tailored e-commerce solutions that combine powerful functionality with exceptional user experiences.
            </p>
            
            <p className="text-lg">
              Today, I leverage modern technologies like Next.js, React, and Node.js alongside Shopify's ecosystem to build scalable e-commerce solutions. My expertise spans from custom theme development to complex app integrations, helping businesses achieve their online retail goals.
            </p>
